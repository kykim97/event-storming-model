        ...
        <v-col style="margin-bottom:40px;">
            <div class="text-center">
                ...
                >
                    ...
                    <DashboardFileStatus :offline="offline" class="video-card" :isNew="true" :editMode="true" v-model="newValue" @add="append" v-if="tick"/>
...
<script>
    ...
    export default {
        ...
        async created() {
            ...
            this.values = temp.data._embedded.filestatuses;
